SELECT hc.nhc, 
      ...
      -- ingresos.cod_cama AS 'Cama Ingreso', --es la cama actual del paciente, entiendo que esa cama no va a ser necesaria.
	   ...
	   case 
            when (episodios.epis_apertura_fech between '20210801' and '20210831') then 'Agosto' 
            when (episodios.epis_apertura_fech between '20210901' and '20210930') then 'Septiembre' 
       end as Mes,
...
WHERE (far_det_pac_car.fdpc_estado_hp IN (4,11) OR (far_det_pac_car.fdpc_estado_hp = 10 AND far_det_pac_car.fdpc_ingta_pk IS NOT NULL))
	  ...
	  AND episodios.epis_apertura_fech >= '01/08/2021'  --Fecha Desde
