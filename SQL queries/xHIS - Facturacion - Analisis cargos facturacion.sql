...
from vale_asis_cab cab
	...
	where
  NHC= 1273733 and det.va_det_fapunte = '20220117' 
  
  
     --and det.va_det_fapunte = '20210311'  order by 	prest.prest_item_cod
 
     -- and prest.prest_item_cod= '1143178' and det.va_det_fapunte > '20201107'  order by det.va_det_fapunte 
	 --and epis.epis_pk = '3033028' and det.va_det_des_manual like '%pension%' --
	 -- and prest.prest_item_cod= 'q010' order by det.va_det_des_manual
