...
from meap_det a
  ...
  inner join urgencias n on n.id_urgencia_pk = l.referencia_id
...
and CAST(a.fecha_registro as date) between '20210201' AND  '20210331'
AND l.tipo_episodio_pk  = 1 --( 1: emg, 2: ccee, 3: int)
