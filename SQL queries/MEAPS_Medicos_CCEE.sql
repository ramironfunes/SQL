...
from meap_det a with (nolock)
  ...
  inner join cex n on n.cex_pk = l.referencia_id
...
AND a.tipo_pk in (5, 2, 3) --5=evoluciones, 2=exploracion, 3=anamnesis
and CAST(a.fecha_registro as date) between '20210201' AND  '20210228'
AND l.tipo_episodio_pk  = 2 --( 1: emg, 2: ccee, 3: int)
