...
select * from far_det_pac_car where prescri_prog_pk



select * from fpersona where codigo_personal = '304156'


301989


select * from usu_usuario usu_id_aux = '304156'


select * from prescri_prog where referencia_id = '35399852'
--referencia_id



select * from hojadisp_detpacar

select * from pres_reg_farma
--linea_orden_pk




select * from far_detalles_ord
--fdo_crea_usu_pk
--fdo_fecha_crea
--fdo_hora_crea
...
select * from fpersona where codigo_personal = '376'
