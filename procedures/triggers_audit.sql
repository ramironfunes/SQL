...
DELIMITER ;
-- se ingresa un nuevo registro en la tabla ORDEN
INSERT INTO ORDEN (Id_Empleado, Id_Cliente, Id_Producto,Fecha, Importe, Id_Mpago, Mesa) VALUES
(2, 2, 2, '2023-07-20',34, 1, 5);
-- SE VALIDA EL REGISTRO TANTO EN LA TABLA ORDEN COMO EN LOG_ORDEN.
SELECT *
FROM ORDEN;
...
-- se borra un registro en la tabla FACTURACION
